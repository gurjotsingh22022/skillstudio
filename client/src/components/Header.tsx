"use client"
import { ChevronDown, ChevronRight, DollarSign, LogOut, Search, Settings, ShoppingBag, ShoppingCart, User } from "lucide-react";
...
function NavbarWithoutUser() {
  ...
  return (
    <div>
      <header
        className={`fixed border-b z-50 w-full bg-white-100 flex gap-8 items-center justify-between py-4 px-8 transition duration-200 ease-in-out ${
          show && "shadow-sm transition duration-200 ease-in-out"
        }`}
      >
      ...
      <NavigationMenuList>
        ...
        <div className="flex gap-4 justify-end items-center w-fit">
...

              {
                ...
                <>
                <Link scroll={false} href="/signin" className="text-lg font-normal w-max mr-4">
                Become Teacher
              </Link>
                </>
                :null
