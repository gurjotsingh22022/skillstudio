...
const Banner = () => {
  return (
    <>
      <div
        style={{
          backgroundImage: `linear-gradient(90deg, hsl(0deg 0% 7% / 91%) 0%, hsl(0deg 0% 0% / 0%) 35%, hsl(220deg 26% 44% / 0%) 100%), url(https://image.tmdb.org/t/p/original/2meX1nMdScFOoV4370rqHWKmXhY.jpg)`,
        }}
        className="h-[50rem] md:h-[55rem] 3xl:h-[63rem] w-full bg-cover bg-center object-contain grid items-center"
      >
        ...
        <div
          style={{
            backgroundImage:
              "linear-gradient(hsl(0deg 0% 0% / 0%), hsl(0deg 0% 0% / 38%), hsl(0deg 0% 6.6%))",
          }}
